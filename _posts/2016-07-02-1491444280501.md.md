...
date:    2016-07-02
excerpt: " JAVA之旅（二十三）——System，RunTime，Date，Calendar，Math的数学运算 map实在是太难写了，整理得我都晕都转向了，以后看来需要开一个专题来讲这个了，现在我们来时来学习一些新的小东西吧 一.System 翻译过来系统的意思，系统类，里面的方法都是静态的，可以直接调用 我们来演示一下吧，先从获取系统信息开始： package com.lgl.hellojava;
